...
In this project (written in Fortran), the molecular weight (in amu unit) of a given molecular structure (eg, C6H6) by the user can be easily calculated, by keeping the files (MwCalc.f90 and Periodic_list.txt) in the same folder. The calculations can be achieved through the terminal, just typing the command:
```sh
