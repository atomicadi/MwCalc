...
!For intial numbers (eg 2H2O, 2Na etc.)
  ...
  400     sum_final = mol_num_int * sum 
          if (sum_final /= 0.0) then 
             go to 300
          end if
           
  100     print *, "Error: Some of the Atoms are not in the Periodic_list, Sorry!"
...
! Edited by Aditya; March 02, 2025; MNIT Jaipur, Rajasthan, India           
